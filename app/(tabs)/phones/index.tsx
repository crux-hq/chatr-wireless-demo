      ...
      <PageScrollView contentContainerStyle={{ padding: spacing.md, paddingBottom: 100 }}>
        ...
        <Card style={{ marginTop: spacing.md, marginBottom: spacing.md }}>
          ...
          <View style={{ flexDirection: 'row', gap: spacing.sm, flexWrap: 'wrap' }}>
            ...
            <Button title={t('phones.physicalSim.findStore')} variant="secondary" onPress={() => router.push('/(tabs)/stores')} />
          </View>
        </Card>
        ...
        <Card style={{ marginBottom: spacing.md }}>
          ...
          <Button title={t('phones.esim.shopPlans')} onPress={() => router.push('/(tabs)/plans')} />
        </Card>
